...
public class Histograms extends ConsoleProgram {
	...
	/* Initialize of histogram array */
	private void initHistogram() {
		histogramArray = new int[11];
		for (int i = 0; i <= 10; i++) {
			histogramArray[i] = 0;
		}
		/* Reads the exam scores, using BufferedReader */
	}
	...
	private static final String DATA_FILE = "C:\\Users\\Abraham\\Stanford106AAssignmentStarters\\MidtermScores.txt";
}
